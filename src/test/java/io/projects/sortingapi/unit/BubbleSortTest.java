...
public class BubbleSortTest {
    ...
    void alreadySorted() {
        ...
        List<Frame> actual = new BubbleSorter().setList(list).setFrames(new ArrayList<>()).generateSortFrames();
    ...
    void reverseSorted() {
        ...
        expected.add(new Frame(new ArrayList<>(List.of(4, 5, 3, 2, 1)), 1));
        expected.add(new Frame(new ArrayList<>(List.of(4, 3, 5, 2, 1)), 2));
        expected.add(new Frame(new ArrayList<>(List.of(4, 3, 2, 5, 1)), 3));
        expected.add(new Frame(new ArrayList<>(List.of(4, 3, 2, 1, 5)), 4));
        expected.add(new Frame(new ArrayList<>(List.of(4, 3, 2, 1, 5)), 0));
        expected.add(new Frame(new ArrayList<>(List.of(3, 4, 2, 1, 5)), 1));
        expected.add(new Frame(new ArrayList<>(List.of(3, 2, 4, 1, 5)), 2));
        expected.add(new Frame(new ArrayList<>(List.of(3, 2, 1, 4, 5)), 3));
        expected.add(new Frame(new ArrayList<>(List.of(3, 2, 1, 4, 5)), 0));
        expected.add(new Frame(new ArrayList<>(List.of(2, 3, 1, 4, 5)), 1));
        expected.add(new Frame(new ArrayList<>(List.of(2, 1, 3, 4, 5)), 2));
        expected.add(new Frame(new ArrayList<>(List.of(2, 1, 3, 4, 5)), 0));
        expected.add(new Frame(new ArrayList<>(List.of(1, 2, 3, 4, 5)), 1));
        expected.add(new Frame(new ArrayList<>(List.of(1, 2, 3, 4, 5)), 0));
        expected.add(new Frame(new ArrayList<>(List.of(1, 2, 3, 4, 5)), null));
